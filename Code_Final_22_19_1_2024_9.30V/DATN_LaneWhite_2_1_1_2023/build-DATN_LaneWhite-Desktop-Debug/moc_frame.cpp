...
#include <memory>
#include "../DATN_LaneWhite/frame.h"
...
QT_MOC_LITERAL(1, 6, 11), // "frameChange"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 14), // "convert2QImage"
QT_MOC_LITERAL(4, 34, 11), // "setRawFrame"
QT_MOC_LITERAL(5, 46, 3), // "Mat"
QT_MOC_LITERAL(6, 50, 5), // "value"
QT_MOC_LITERAL(7, 56, 5) // "frame"

    },
    "Frame\0frameChange\0\0convert2QImage\0"
    "setRawFrame\0Mat\0value\0frame"
};
...
void Frame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->frameChange(); break;
        case 1: _t->convert2QImage(); break;
        case 2: _t->setRawFrame((*reinterpret_cast< const Mat(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Frame::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Frame::frameChange)) {
                *result = 0;
                return;
            }
        }
