...
#include <memory>
#include "../DATN_LaneWhite/serialportmanager.h"
...
QT_MOC_LITERAL(1, 18, 18), // "dataArduinoChanged"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 21), // "valueDistance_Arduino"
QT_MOC_LITERAL(4, 60, 8), // "distance"
QT_MOC_LITERAL(5, 69, 8), // "readData"
QT_MOC_LITERAL(6, 78, 9), // "writeData"
QT_MOC_LITERAL(7, 88, 6), // "result"
QT_MOC_LITERAL(8, 95, 11) // "dataArduino"

    },
    "SerialPortManager\0dataArduinoChanged\0"
    "\0valueDistance_Arduino\0distance\0"
    "readData\0writeData\0result\0dataArduino"
};
...
void SerialPortManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dataArduinoChanged(); break;
        case 1: _t->valueDistance_Arduino((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->readData(); break;
        case 3: _t->writeData((*reinterpret_cast< const int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialPortManager::dataArduinoChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialPortManager::valueDistance_Arduino)) {
                *result = 1;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->dataArduino(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setDataArduino(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
...
// SIGNAL 0
void SerialPortManager::dataArduinoChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SerialPortManager::valueDistance_Arduino(int _t1)
{
